...
public class Encryption {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeyException, IOException {
        ...
        String apiKey = "LLQl52O8OFhotOL1P4";
        String secret = "11AKm6SzKjOnTuCFNbZJ34LYzo7WzsGnhOG8";
     ...
     * @return
     */
    public static String genQueryString(TreeMap<String, String> params, String secret) throws NoSuchAlgorithmException, InvalidKeyException {

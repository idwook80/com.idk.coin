 ...
 */
	...
	public void setShort() throws Exception{
		...
		closeShort(27610, OVER, 27560, QTY, RR);
		closeShort(27510, OVER, 27310, QTY, RR);
		//closeShort(27410, OVER, 27210, QTY, RR);
		//closeShort(27310, OVER, 27110, QTY, RR);
		
		/** ↑↑↑↑ -------  Price Line  27722  -------  Long First ↓↓↓↓  **/
		openShort(27210, UNDER, 27410, QTY, RR);
		openShort(27110, UNDER, 27310, QTY, RR);
	 
	}
	/** ###########  [Model 01] ########### **/
	public void createCloseShort()throws Exception{
		
		//createCloseShort(27210, UNDER, 27010, QTY, 27160, RR);
	
		openShort(27110, UNDER, 27310, QTY, RR, 27110);
		
		openShort(26910, UNDER, 27110, QTY, RR, 26910);
		openShort(26710, UNDER, 26910, QTY, RR, 26810);
		openShort(26510, UNDER, 26710, QTY, RR, 26610);
		openShort(26310, UNDER, 26510, QTY, RR, 26410);
		openShort(26110, UNDER, 26310, QTY, RR, 26210);
		...
		openShort(25910, UNDER, 26110, QTY, RR);
		openShort(25710, UNDER, 25910, QTY, RR);
		openShort(25510, UNDER, 25710, QTY, RR);
		openShort(25310, UNDER, 25510, QTY, RR);
		openShort(25110, UNDER, 25310, QTY, RR);
 ...
 */
	public void createCloseLong() throws Exception{
		...
		openLong(29010, OVER, 28810, QTY, RR);
		openLong(28810, OVER, 28610, QTY, RR);
		openLong(28610, OVER, 28410, QTY, RR);
		openLong(28410, OVER, 28210, QTY, RR);
		openLong(28210, OVER, 28010, QTY, RR);
		
		openLong(28010, OVER, 27810, QTY, RR, 27910);
		openLong(27810, OVER, 27610, QTY, RR, 27710);
		openLong(27610, OVER, 27410, QTY, RR, 27510);
		
		//openLong(27410, OVER, 27210, QTY, RR, 27310);
	...
	public void setLong() throws Exception{
		...
		closeLong(27210, UNDER, 27410, QTY, RR);
	...
	public void createOpenLong() throws Exception{
		...
		createOpenLong(27110, UNDER, 26910, QTY, 27110, RR);

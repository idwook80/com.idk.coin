...
public class AlarmManager100 extends BybitAlarmsModel {
	...
	public AlarmManager100(String symbol, BybitUser user) throws Exception{
		super(symbol, user);
	}
	public AlarmManager100(String symbol, String web_id, String web_pw) throws Exception{
